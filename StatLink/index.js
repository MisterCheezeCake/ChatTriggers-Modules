...
const cl = new Changelog("StatLink","&e1.1.0", "&aThe /sl command now acts as the main command for the mod. Dedicated commands are still included but are depricated");
cl.writeChangelog();